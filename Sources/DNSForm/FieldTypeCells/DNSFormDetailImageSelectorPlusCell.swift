...
open class DNSFormDetailImageSelectorPlusCell: DNSBaseStageCollectionViewCell,
    ...
    public struct Data: Hashable {
        ...
        public init(field: String, formatPattern: String = "", label: String, languageCode: String, media: DAOMedia? = nil, placeholder: String, readonly: Bool, required: Bool, type: DNSFormFieldType = .none) {
            self.field = field
