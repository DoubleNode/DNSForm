...
open class DNSFormDetailTextViewLargeCell: DNSBaseStageCollectionViewCell,
    ...
    static public let recommendedContentSize = CGSize(width: 414, height: 448)
    static public let heightForSection: Double = recommendedContentSize.height
    static public let defaultMaximumLength: Int = 1200
    ...
    public func animatedFieldLimit(_ animatedField: AnimatedField) -> Int? {
        guard let data = self.data else { return Self.defaultMaximumLength }
        return data.maximumLength
    }
