...
public enum DNSFormStage {
    ...
    static public func register(to collectionView: UICollectionView) {
        ...
        DNSFormDetailPostalAddressNicknameCell.register(to: collectionView, from: Bundle.module)
        ...
        DNSFormDetailSectionFooterCell.register(to: collectionView, from: Bundle.module)
