...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSForm.git", from: "1.10.52")
]
```

## Dependencies

-   AnimatedField (DN fork) v2.5.31+
-   DNSAppCore v1.10.0+
-   DNSBaseStage v1.10.6+
-   DNSBaseTheme v1.10.1+
-   DNSBlankWorkers v1.10.18+
-   DNSCore v1.10.4+
-   DNSCoreThreading v1.10.0+
-   DNSCrashNetwork v1.10.0+
-   DNSCrashSystems v1.10.0+
-   DNSProtocols v1.10.25+
-   SFSymbol v1.1.0+
