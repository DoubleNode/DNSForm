...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSForm.git", from: "1.10.270")
]
```

## Dependencies

-   AnimatedField (DN fork) v2.5.49+
-   DNSAppCore v1.10.2+
-   DNSBaseStage v1.10.46+
-   DNSBaseTheme v1.10.26+
-   DNSBlankWorkers v1.10.62+
-   DNSCore v1.10.48+
-   DNSCoreThreading v1.10.1+
-   DNSCrashNetwork v1.10.2+
