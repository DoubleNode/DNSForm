...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSBaseStage.git", from: "1.9.14"),
        .package(url: "https://github.com/DoubleNode/DNSBaseTheme.git", from: "1.9.2"),
        .package(url: "https://github.com/DoubleNode/DNSBlankWorkers.git", from: "1.9.56"),
        .package(url: "https://github.com/DoubleNode/DNSCore.git", from: "1.9.27"),
