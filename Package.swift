...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNodeOpen/AnimatedField.git", from: "2.5.43"),
        .package(url: "https://github.com/DoubleNode/DNSAppCore.git", from: "1.10.2"),
        .package(url: "https://github.com/DoubleNode/DNSBaseStage.git", from: "1.10.20"),
        .package(url: "https://github.com/DoubleNode/DNSBaseTheme.git", from: "1.10.1"),
        .package(url: "https://github.com/DoubleNode/DNSBlankWorkers.git", from: "1.10.28"),
        .package(url: "https://github.com/DoubleNode/DNSCore.git", from: "1.10.16"),
        ...
        .package(url: "https://github.com/DoubleNode/DNSProtocols.git", from: "1.10.42"),
