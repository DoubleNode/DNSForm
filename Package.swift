...
//        .macOS(.v13),
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNodeOpen/AnimatedField.git", from: "2.5.55"),
        .package(url: "https://github.com/DoubleNode/DNSAppCore.git", from: "1.11.0"),
        .package(url: "https://github.com/DoubleNode/DNSBaseStage.git", from: "1.11.4"),
        ...
        .package(url: "https://github.com/rajdeep/proton.git", from: "0.8.33"),
