...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSBaseStage.git", from: "1.9.33"),
        .package(url: "https://github.com/DoubleNode/DNSBaseTheme.git", from: "1.9.14"),
        .package(url: "https://github.com/DoubleNode/DNSBlankWorkers.git", from: "1.9.64"),
        ...
        .package(url: "https://github.com/DoubleNode/DNSProtocols.git", from: "1.9.90"),
