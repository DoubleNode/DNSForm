...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNodeOpen/AnimatedField.git", .upToNextMajor(from: "2.5.71")),
        .package(url: "https://github.com/DoubleNode/DNSAppCore.git", .upToNextMajor(from: "1.12.0")),
        .package(url: "https://github.com/DoubleNode/DNSBaseStage.git", .upToNextMajor(from: "1.12.1")),
