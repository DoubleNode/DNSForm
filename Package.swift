...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSBaseStage.git", from: "1.10.26"),
        ...
        .package(url: "https://github.com/DoubleNode/DNSCore.git", from: "1.10.31"),
        ...
        .package(url: "https://github.com/DoubleNode/DNSProtocols.git", from: "1.10.55"),
