...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/DoubleNode/DNSBaseStage.git", from: "1.9.12"),
        .package(url: "https://github.com/DoubleNode/DNSBaseTheme.git", from: "1.9.2"),
        .package(url: "https://github.com/DoubleNode/DNSBlankWorkers.git", from: "1.9.55"),
        .package(url: "https://github.com/DoubleNode/DNSCore.git", from: "1.9.23"),
        ...
        .package(url: "https://github.com/DoubleNode/DNSProtocols.git", from: "1.9.80"),
